...
public class CertificatnonMariageNonRemariage {
	...
	private String prenom_MariActuel;
	private String nom_MariActuel;
	...
	public String getPrenom_MariActuel() {
		return prenom_MariActuel;
	}
	public void setPrenom_MariActuel(String prenom_MariActuel) {
		this.prenom_MariActuel = prenom_MariActuel;
	}
	public String getNom_MariActuel() {
		return nom_MariActuel;
	}
	public void setNom_MariActuel(String nom_MariActuel) {
		this.nom_MariActuel = nom_MariActuel;
	}
